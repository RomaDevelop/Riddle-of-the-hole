...
class MyQExcelHasher: public LogedClass
{
...
public:
	...
	enum errors {noError, cantCrDir, cantOpenExcelFile, cantOpenFileHashes, cantOpenFileHash, cantOpenFileNew, cantOpenNewFileHash};
