...
int MyQExcelHasher::InitFile(QString directory, QString fileName/*, QString &labelForMsgs_*/, QWidget *mainWindow)
{
//	labelForMsgs = &labelForMsgs_;
	...
	else
	{
		...
		emit static_cast<MainWindow*>(mainWindow)->SignalReadExcelFinished();
